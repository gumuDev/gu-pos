...
import com.pos.support.infrastructure.adapter.out.persistence.jpa.JpaSupportReportRepositoryImpl;
...
public class SupportJpaBeanConfig {

    @Value("${telegram.admin-chat-id:0}")
    private long adminChatId;

    @Bean
    public SupportReportRepository supportReportRepository(JpaSupportReportRepository jpa) {
        return new JpaSupportReportRepositoryImpl(jpa);
    }
